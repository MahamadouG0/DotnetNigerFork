        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailConfirmationCodeExpiry = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HealthEndpoint = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    Status = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    LastHealthCheckAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    HealthCheckFailures = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrivateKeyHash = table.Column<string>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalServices_TenantId",
                table: "ExternalServices",
                column: "TenantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantApiKeys_PublicKey",
                table: "TenantApiKeys",
                column: "PublicKey",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TenantClients_ClientId",
                table: "TenantClients",
                column: "ClientId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TenantClients_TenantId",
                table: "TenantClients",
                column: "TenantId");
